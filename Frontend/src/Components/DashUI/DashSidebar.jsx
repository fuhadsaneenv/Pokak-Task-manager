...
// export function DashSidebar({ selectedDate, onDateSelect, onTodayClick, selectedView, lists, tasks }) {
//   const tasksSection = [{ id: 1, name: 'Today', count: tasks.filter(t => !t.completed).length }]
...
//                   } hover:bg-gray-50`}
//                   onClick={() => onTodayClick(task.name)}
//                 >
//                   <span>{task.name}</span>
...
//                 <li key={list.id}>
//                   <button
//                     className="w-full px-4 py-2 flex justify-between items-center text-sm hover:bg-gray-50"
//                     onClick={() => console.log(`${list.name} clicked`)}
//                   >
//                     <span>{list.name}</span>
