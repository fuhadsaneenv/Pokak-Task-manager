          ...
          <div className="bg-gray-50 rounded-2xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-2">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-12 h-6 bg-gray-300 rounded-full peer transition-colors peer-checked:bg-gray-600">
                  <span
            ...
            <div className="flex gap-1">
              {weekdays.map((day) => (
                <button
                  ...
                  className={`flex-1 h-10 text-sm flex items-center justify-center rounded-full transition-colors ${
